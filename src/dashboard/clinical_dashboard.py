...
"""
Professional Clinical Interface for Neuro-Genomic AI
This interface is designed for maternal-fetal medicine specialists to provide a clear, actionable interface for interpreting AI-driven fetal health assessments. It emphasizes clinical relevance, ease of use, and integration with existing workflows.
"""
...
# Page config
st.set_page_config(
    page_title="Neuro-Genomic AI | Clinical View",
    page_icon="🧬",
    layout="wide",
...
if st.session_state.analysis_complete and st.session_state.results:
    ...
    **For Maternal-Fetal Medicine Specialists**
    ...
    This interface provides AI-powered analysis of fetal heart rate variability to assess:
