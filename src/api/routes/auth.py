...
DEFAULT_ADMIN_EMAIL = os.getenv("DEFAULT_ADMIN_EMAIL", "admin@neuro.com")
DEFAULT_ADMIN_PASSWORD = os.getenv("DEFAULT_ADMIN_PASSWORD", "TempPass123!")
DEFAULT_ADMIN_FULL_NAME = os.getenv("DEFAULT_ADMIN_FULL_NAME", "Neuro Genomic Admin")

if DEFAULT_ADMIN_EMAIL not in MOCK_USERS_DB:
    MOCK_USERS_DB[DEFAULT_ADMIN_EMAIL] = {
        "id": "user_1",
